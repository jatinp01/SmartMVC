$('.refresh').on('click', 'a', function (e) {
    var url = '/Company/List?PageIndex=1';
    $("#search").val("")
    $.get(url, function (data) {
        ...
        $.each(data.Result, function (i, company) {
            htmlresponse += '<tr>';
            htmlresponse += '<td><a href="/Company/Edit/' + company.Id + '"><span class="glyphicon glyphicon-edit"></span></a></td>';
            htmlresponse += '<td>' + company.Name + '</td>';
            htmlresponse += '<td>' + company.Address + '</td>';
            htmlresponse += '<td>' + company.ContactNo + '</td>';
            htmlresponse += '<td>' + company.Email + '</td>';
            htmlresponse += '<td><a href="#" class="delete" param="' + company.Id + '"><span class="glyphicon glyphicon-remove"></span></a></td>';
            htmlresponse += '</tr>';
        });
...
$('.pagination').on('click', '.index', function (e) {
    var url = '/Company/List?PageIndex=' + $(this).text();
