$('.refresh').on('click', 'a', function (e) {
    var url = '/Status/List?PageIndex=1';
    $("#search").val("")
    $.get(url, function (data) {
        ...
        $.each(data.Result, function (i, Status) {
            htmlresponse += '<tr>';
            htmlresponse += '<td><a href="/Status/Edit/' + Status.Id + '"><span class="glyphicon glyphicon-edit"></span></a></td>';
            htmlresponse += '<td>' + Status.Status + '</td>';
            htmlresponse += '<td><a href="#" class="delete" param="' + Status.Id + '"><span class="glyphicon glyphicon-remove"></span></a></td>';
            htmlresponse += '</tr>';
        });
...
$('.pagination').on('click', '.index', function (e) {
    var url = '/Status/List?PageIndex=' + $(this).text();
