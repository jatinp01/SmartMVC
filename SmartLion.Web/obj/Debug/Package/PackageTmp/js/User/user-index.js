$('.refresh').on('click', 'a', function (e) {
    ...
    $.get(url, function (data) {
        ...
        $.each(data.Result, function (i, user) {
            htmlresponse += '<tr>';
            htmlresponse += '<td><a href="/User/Edit/' + user.Id + '"><span class="glyphicon glyphicon-edit"></span></a></td>';
            htmlresponse += '<td>' + user.UserName + '</td>';
            htmlresponse += '<td>' + user.FullName + '</td>';
            htmlresponse += '<td>' + user.RoleName + '</td>';
            htmlresponse += '<td>' + user.StatusName + '</td>';
            htmlresponse += '<td><a href="#" class="delete" param="' + user.Id + '"><span class="glyphicon glyphicon-remove"></span></a></td>';
            htmlresponse += '</tr>';
        });
...
$('.pagination').on('click', '.index', function (e) {
    var url = '/User/List?PageIndex=' + $(this).text();
